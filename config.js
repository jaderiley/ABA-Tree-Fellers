...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "ABA Tree Fellers",
    phone:     "+27 82 786 3225",
    whatsapp:  "+27 82 786 3225",
    address:   "Honeydew, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "ABA Tree Fellers — Tree felling in honeydew",
    description: "ABA Tree Fellers provides professional tree felling in Honeydew. 1 Google review. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Tree felling · Honeydew & surrounds",
    heroTitle:  "Safe tree felling — <em>from assessment to clean-up.</em>",
    heroLead:   "ABA Tree Fellers handles tree felling, stump removal and trimming across Honeydew and the surrounding suburbs. Professional equipment, safe teams, clean site.",
    ...
    band: {
      ...
      alt:   "ABA Tree Fellers team at work in Honeydew",
      text:  "Safe, efficient tree felling — from assessment to clean-up."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Honeydew. Covering the wider area.",
    areasLead:  "We work across Honeydew, Johannesburg, Randburg and the surrounding suburbs. Emergency callouts for storm damage handled as quickly as possible.",
